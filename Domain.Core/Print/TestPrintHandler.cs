...
{
    public class TestPrintHandler : _BasePrintHandler, IPrintHandler<TestRequest, Response>
    {

        public TestPrintHandler(ICommandProcessor commandProcessor, IServiceManager serviceManager, IQueryProcessor queryProcessor) :
            base(commandProcessor, serviceManager, queryProcessor)
        { }


        public Response Print(TestRequest request)
        {
            ...
            //analizo respuesta y expiro si no hubo error de comunicacion
